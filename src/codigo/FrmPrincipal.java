...
public class FrmPrincipal extends javax.swing.JFrame {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 495,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(btnAnalizar, javax.swing.GroupLayout.PREFERRED_SIZE, 136,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap()));
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(btnAnalizar, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void analizarArchivo(
            ...
            List<String> erroresSemanticos) throws IOException {
        ...
        try (Reader lector = new BufferedReader(new FileReader(archivo))) {
            ...
            while (true) {
                ...
                String tipo = sym.terminalNames[token.sym]; // Aquí estaba el error \u00a0
    ...
    private String construirResumen(
        ...
        for (var eTipo : idx.entrySet()) {
            ...
            for (var eLex : eTipo.getValue().entrySet()) {
                ...
                out.append(String.format("%-24s  %-20s  %s\n", lexema, tipo, pos)); // Espacios normales en el formato
            }
        }
        ...
        // ---- Errores semánticos (NUEVA SECCIÓN) ----
        out.append("\n=== Errores semánticos ===\n");
        if (erroresSemanticos.isEmpty()) {
            out.append("No se encontraron errores semánticos.\n");
        } else {
